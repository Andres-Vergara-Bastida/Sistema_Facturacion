...
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturación', fg='azure4',
                        font=('Arial', 65), bg='burlywood', width=18)
...
# Panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text='Comidas', font=('Dosis', 25, 'bold'),
                                                                 bd=1, relief=FLAT, fg='azure4')
panel_comidas.pack(side=LEFT)

# Panel bebidas
panel_bebidas = LabelFrame(panel_izquierdo, text='Bebidas', font=('Dosis', 25, 'bold'),
                                                                 bd=1, relief=FLAT, fg='azure4')
panel_bebidas.pack(side=LEFT)

# Panel postres
panel_postres = LabelFrame(panel_izquierdo, text='Postres', font=('Dosis', 25, 'bold'),
                                                                 bd=1, relief=FLAT, fg='azure4')
...
# lista de productos
lista_comidas = ['pollo','cordero','salmon','merluza','pizza1','pizza2','pizza3','pizza4']
lista_bebidas = ['agua','coca-cola','cerveza','zumo','vino1','vino2','vino3','vino4']
